...
examples:
	...
	@echo "$(BLUE)$(RUN) examples/fire-up-group-minimal.py$(NC) $(GREEN)ingestion run$(NC)"
	@$(RUN) examples/fire-up-group-minimal.py ingestion run
	@echo "$(BLUE)$(RUN) examples/fire-up-group-minimal.py$(NC) $(GREEN)digestion run$(NC)"
	@$(RUN) examples/fire-up-group-minimal.py digestion run
	@echo "$(BLUE)$(RUN) examples/fire-up-group-minimal.py$(NC) $(GREEN)digestion status$(NC)"
	@$(RUN) examples/fire-up-group-minimal.py digestion status
	@echo "$(BLUE)$(RUN) examples/fire-up-group-minimal.py$(NC) $(GREEN)--all ingestion run then digestion run$(NC)"
	@$(RUN) examples/fire-up-group-minimal.py --all ingestion run then digestion run
